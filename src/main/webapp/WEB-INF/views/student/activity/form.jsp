...
<acme:form>
    ...
    <acme:input-textarea code="student.activity.form.label.abstractt" path="abstractt"/>
    <acme:input-select code="student.activity.form.label.activityType" path="activityType" choices="${types}"/>
